...
public class BloomNeuralNetLayer extends BaseNeuralNetLayer
{
    ...
    public void loadParameters()
    {
        ...
        loadMatrix(MLP_1_TRANSPOSED_WEIGHT, "mlp.dense_h_to_4h.weight", feedForwardSize, hiddenSize);
        loadVector(MLP_1_BIAS, "mlp.dense_h_to_4h.bias", feedForwardSize);
        loadMatrix(MLP_2_TRANSPOSED_WEIGHT, "mlp.dense_4h_to_h.weight", hiddenSize, feedForwardSize);
    ...
    private Vector neuralNet(Vector hiddenState)
    {
        ...
        hiddenState = MATH.mulVectorByTransposedMatrix(hiddenState, matrix(MLP_1_TRANSPOSED_WEIGHT));
        ...
        hiddenState = MATH.mulVectorByTransposedMatrix(hiddenState, matrix(MLP_2_TRANSPOSED_WEIGHT));

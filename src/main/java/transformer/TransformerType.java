...
import transformers._2018_06_openai_gpt1.parallel.ParallelGPT1;
import transformers._2018_06_openai_gpt1.parallel.ParallelGPT1AttentionLayer;
import transformers._2018_06_openai_gpt1.parallel.ParallelGPT1NeuralNetLayer;
import transformers._2018_06_openai_gpt1.serial.GPT1;
import transformers._2018_06_openai_gpt1.serial.GPT1AttentionLayer;
import transformers._2018_06_openai_gpt1.serial.GPT1NeuralNetLayer;
...
import transformers._2019_02_openai_gpt2.parallel.ParallelGPT2;
import transformers._2019_02_openai_gpt2.parallel.ParallelGPT2AttentionLayer;
import transformers._2019_02_openai_gpt2.parallel.ParallelGPT2NeuralNetLayer;
import transformers._2019_02_openai_gpt2.serial.GPT2;
import transformers._2019_02_openai_gpt2.serial.GPT2AttentionLayer;
import transformers._2019_02_openai_gpt2.serial.GPT2NeuralNetLayer;
...
import transformers._2024_02_google_gemma.parallel.ParallelGemma;
import transformers._2024_02_google_gemma.parallel.ParallelGemmaAttentionLayer;
import transformers._2024_02_google_gemma.parallel.ParallelGemmaNeuralNetLayer;
import transformers._2024_02_google_gemma.serial.Gemma;
import transformers._2024_02_google_gemma.serial.GemmaAttentionLayer;
import transformers._2024_02_google_gemma.serial.GemmaNeuralNetLayer;
...
public enum TransformerType
{
    ...
    public static ParallelBaseTransformer getParallelTransformer(String transformerType)
    {
        ...
        return switch (type)
        {
            ...
            case OPENAI_GPT_2             -> new ParallelGPT2();
    ...
    public static ParallelBaseAttentionLayer getParallelAttentionLayer(String transformerType)
    {
        ...
        return switch (type)
        {
            ...
            case OPENAI_GPT_2             -> new ParallelGPT2AttentionLayer();
    ...
    public static ParallelBaseNeuralNetLayer getParallelNeuralNetLayer(String transformerType)
    {
        ...
        return switch (type)
        {
            ...
            case OPENAI_GPT_2             -> new ParallelGPT2NeuralNetLayer();
